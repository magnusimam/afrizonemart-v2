...
/**
 * Body of the Civic Library document-submission flow, extracted from
 * the old standalone /admin/document-submissions page so it can be
 * hosted as one tab of the combined /admin/submissions page
 * (2026-08-01). Reuses `DocumentForm` in `hideStatus` mode — same
 * component the admin editor uses, just without the Draft/Published
 * controls (a reviewer decides what happens next, not the intern).
 */
    ...
    <div className="space-y-6">
      ...
      <section className="rounded-card border border-border bg-white">
        <header className="border-b border-border px-5 py-3">
          <h2 className="font-raleway text-lg font-bold text-navy">My document submissions</h2>
        </header>
        {items === null ? (
