...
const NAV: NavItem[] = [
  ...
  { href: '/admin/suppliers', label: 'Supplier PIQs', icon: ClipboardList, cap: 'suppliers.review' },
  { href: '/admin/facility-visits', label: 'Facility visits', icon: CalendarCheck, cap: 'suppliers.visits' },
  { href: '/admin/supplier-audits', label: 'Product audits', icon: ClipboardCheck, cap: 'suppliers.audit' },
  { href: '/admin/orientation', label: 'Orientation & calls', icon: Radio, cap: 'suppliers.review' },
  { href: '/admin/production', label: 'Production (Take50)', icon: Camera, cap: 'suppliers.production' },
  { href: '/admin/trade', label: 'Activation & trade', icon: ShoppingCart, cap: 'suppliers.trade' },
